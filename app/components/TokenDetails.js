    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex w-full p-6">
        ...
        <div
          ...
          className="border-[1px] w-[50%] mt-6 border-[#D5D5D5] text-center bg-white relative"
          ...
          <div className="mt-12 px-4 text-center">
            ...
            <div className="flex gap-6 mt-4 items-center justify-center ">
              <div className="flex gap-2 justify-center items-center">
                <Image style={{ color: "#7C7C7C" }} width={40} alt="Token" height={40} src={token.image} className="w-[10px] h-[10px] flex items-center justify-center text-[#C7C7C7]" />
                <p className="text-[#7C7C7C] font-normal font-secondary text-[12px]">Website</p>
              </div>
              <div className="flex gap-2 justify-center items-center">
                <Image style={{ color: "#7C7C7C" }} width={40} alt="Token" height={40} src={token.image1} className="w-[10px] h-[10px] flex items-center justify-center text-[#C7C7C7]" />
                <p className="text-[#7C7C7C] font-normal font-secondary text-[12px]">Twitter</p>
              </div>
              <div className="flex gap-2 justify-center items-center">
                <Image style={{ color: "#7C7C7C" }} width={40} alt="Token" height={40} src={token.image2} className="w-[10px] h-[10px] flex items-center justify-center text-[#C7C7C7]" />
            ...
            <div className='flex px-4 py-2 border-[1px] border-[#D5D5D5]'>
              ...
              <div className='flex justify-center items-center gap-2'>
                ...
                <Image
                  ...
                  src={coin} alt='coin' width={40} height={40} />
              </div>
            </div>
